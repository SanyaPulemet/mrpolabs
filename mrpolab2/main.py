...
order1 = Order(1, client1, datetime.now(), 'address1', courier1, [burgerSet, burger], 12413312312)
order2 = Order(2, client2, datetime.now(), 'address2', courier2, [burgerSet, burger], 12413312311)
